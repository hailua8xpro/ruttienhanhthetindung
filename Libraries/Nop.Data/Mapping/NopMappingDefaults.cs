...
namespace Nop.Data.Mapping
{
    ...
    public static partial class NopMappingDefaults
    {
        ...
        public static string NewsCategoryTable => "NewsCategory";
        public static string NewsCategoryMappingTable => "News_Category_Mapping";
        public static string ServiceCategoryMappingTable => "Service_Category_Mapping";
