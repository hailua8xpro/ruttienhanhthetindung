...
namespace Nop.Web.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        private readonly IServiceItemModelFactory _serviceItemModelFactory;
            ...
            IServiceItemModelFactory serviceModelFactory)
        {
            ...
            this._serviceItemModelFactory = serviceModelFactory;
        }
        ...
        public virtual TopMenuModel PrepareTopMenuModel()
        {
            ...
            List<NewsCategorySimpleModel> newsCategories = null;
            if(_newsSettings.Enabled && _displayDefaultMenuItemSettings.DisplayNewsMenuItem)
                newsCategories = _newsCategoryModelFactory.PrepareCategorySimpleModels();
            IList<ServiceSimpleModel> services = null;
            List<ServiceCategorySimpleModel> serviceCategories = null;
            if (_serviceSettings.Enabled && _displayDefaultMenuItemSettings.DisplayServiceMenuItem && _displayDefaultMenuItemSettings.DisplayServiceCategoryMenuItem)
                serviceCategories = _serviceCategoryModelFactory.PrepareCategorySimpleModels();
            else if(_serviceSettings.Enabled && _displayDefaultMenuItemSettings.DisplayServiceMenuItem && !_displayDefaultMenuItemSettings.DisplayServiceCategoryMenuItem)
            {
                services = _serviceItemModelFactory.PrepareServiceSimpleModels();
            }
            var model = new TopMenuModel
            {
                ...
                DisplayNewsMenuItem= _displayDefaultMenuItemSettings.DisplayNewsMenuItem,
                ServiceEnabled=_serviceSettings.Enabled,
                DisplayServiceMenuItem=_displayDefaultMenuItemSettings.DisplayServiceMenuItem,
                DisplayServiceCategoryMenuItem= _displayDefaultMenuItemSettings.DisplayServiceCategoryMenuItem
            };
            return model;
        }
