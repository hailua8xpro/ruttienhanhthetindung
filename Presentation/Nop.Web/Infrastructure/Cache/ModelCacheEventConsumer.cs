...
namespace Nop.Web.Infrastructure.Cache
{
    ...
    public partial class ModelCacheEventConsumer :
        ...
        //banner
        IConsumer<EntityInsertedEvent<Banner>>,
        IConsumer<EntityUpdatedEvent<Banner>>,
        IConsumer<EntityDeletedEvent<Banner>>,
        // testimonial
        IConsumer<EntityInsertedEvent<Testimonial>>,
        IConsumer<EntityUpdatedEvent<Testimonial>>,
        IConsumer<EntityDeletedEvent<Testimonial>>

    {
        ...
        public const string NEWSCATEGORY_BREADCRUMB_KEY = "Nop.pres.newscategory.breadcrumb-{0}-{1}-{2}-{3}";
        public const string NEWSCATEGORY_BREADCRUMB_PATTERN_KEY = "Nop.pres.newscategory.breadcrumb";

        public const string SERVICECATEGORY_BREADCRUMB_KEY = "Nop.pres.servicecategory.breadcrumb-{0}-{1}-{2}-{3}";
        public const string SERVICECATEGORY_BREADCRUMB_PATTERN_KEY = "Nop.pres.servicecategory.breadcrumb";

        public const string NEWS_CATEGORY_PATTERN_KEY = "Nop.pres.newscategory";
        public const string NEWS_CATEGORY_ALL_MODEL_KEY = "Nop.pres.newscategory.all-{0}-{1}-{2}";

        public const string SERVICE_CATEGORY_PATTERN_KEY = "Nop.pres.servicecategory"; 
        public const string SERVICE_CATEGORY_ALL_MODEL_KEY = "Nop.pres.servicecategory.all-{0}-{1}-{2}";

        public const string SERVICE_PATTERN_KEY = "Nop.pres.service";
        public const string SERVICE_ALL_MODEL_KEY = "Nop.pres.service.all-{0}-{1}-{2}";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string NEWSITEM_PICTURE_MODEL_KEY = "Nop.pres.news.picture-{0}-{1}-{2}";
        /// <summary>
        /// 
        /// </summary>
        public const string NEWSITEMS_CATEGORY_KEY = "Nop.pres.news.newsitem.categoryfirst-{0}-{1}";
        /// <summary>
        ...
        public const string BANNER_KEY = "Nop.pres.banner-{0}-{1}-{2}";

        public const string TESTIMOMIAL_PATTERN_KEY = "Nop.pres.testimonial";
        public const string HOMEPAGE_TESTIMOMIAL_KEY = "Nop.pres.testimonial.hometestimonial-{0}";
        #endregion
        #endregion
        ...
        public void HandleEvent(EntityUpdatedEvent<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(NEWS_CATEGORY_PATTERN_KEY); //depends on NewsSettings.MainPageNewsCount
        ...
        //banners
        public void HandleEvent(EntityInsertedEvent<Banner> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdatedEvent<Banner> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PATTERN_KEY);

        }
        public void HandleEvent(EntityDeletedEvent<Banner> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PATTERN_KEY);

        }
        //testimonial
        public void HandleEvent(EntityInsertedEvent<Testimonial> eventMessage)
        {
            _cacheManager.RemoveByPattern(TESTIMOMIAL_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdatedEvent<Testimonial> eventMessage)
        {
            _cacheManager.RemoveByPattern(TESTIMOMIAL_PATTERN_KEY);

        }
        public void HandleEvent(EntityDeletedEvent<Testimonial> eventMessage)
        {
            _cacheManager.RemoveByPattern(TESTIMOMIAL_PATTERN_KEY);
        ...
        public void HandleEvent(EntityInsertedEvent<NewsCategory> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(NEWS_CATEGORY_PATTERN_KEY);
        }
