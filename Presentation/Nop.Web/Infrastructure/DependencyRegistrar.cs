...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<ServiceCategoryModelFactory>().As<IServiceCategoryModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<Factories.NewsCategoryModelFactory>().As<Factories.INewsCategoryModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<Factories.ServiceCategoryModelFactory>().As<Factories.IServiceCategoryModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<Factories.ServiceItemModelFactory>().As<Factories.IServiceItemModelFactory>().InstancePerLifetimeScope();
        }
