...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBaseAdminModelFactory
    {
        ...
        void PrepareBannerCategoryEntity(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null, BannerType bannerType = BannerType.Home);
        void PrepareNewsCategories(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        void PrepareServiceCategories(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        #endregion
    }
}