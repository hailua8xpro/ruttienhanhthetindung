...
namespace Nop.Web.Areas.Admin.Models.News
{
    ...
    public partial class NewsItemModel : BaseNopEntityModel, IStoreMappingSupportedModel
    {
        ...
        public NewsItemModel()
        {
            ...
            SelectedNewsCategoryIds = new List<int>();
        }
        ...
        //categories
        [NopResourceDisplayName("Admin.ContentManagement.News.NewsItems.Fields.Categories")]
        public IList<int> SelectedNewsCategoryIds { get; set; }
