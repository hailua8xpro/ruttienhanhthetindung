...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateNewsCategoryMaps()
        {
            CreateMap<NewsCategory, NewsCategoryModel>()
                ...
                .ForMember(model => model.AvailableCategories, options => options.Ignore())
                .ForMember(model => model.Breadcrumb, options => options.Ignore())
                .ForMember(model => model.CategoryNewsSearchModel, options => options.Ignore());
        ...
        protected virtual void CreateServiceCategoryMaps()
        {
            CreateMap<ServiceCategory, ServiceCategoryModel>()
                ...
                .ForMember(model => model.AvailableCategories, options => options.Ignore())
                .ForMember(model => model.Breadcrumb, options => options.Ignore())
                .ForMember(model => model.CategoryServiceSearchModel, options => options.Ignore());
            CreateMap<ServiceCategoryModel, ServiceCategory>()
                .ForMember(model => model.CreatedOnUtc, options => options.Ignore())
                .ForMember(model => model.SubjectToAcl, options => options.Ignore())
                .ForMember(model => model.UpdatedOnUtc, options => options.Ignore());
        }
        protected virtual void CreateServiceMaps()
        {
            CreateMap<Service, ServiceModel>()
                .ForMember(model => model.SeName, options => options.MapFrom(entity => EngineContext.Current.Resolve<IUrlRecordService>().GetSeName(entity, 0, true, false)))
                .ForMember(model => model.Locales, options => options.Ignore())
                .ForMember(model => model.AvailableServiceCategories, options => options.Ignore());
        ...
        protected virtual void CreateBannersMaps()
        {
            CreateMap<Banner, BannerModel>()
                .ForMember(model => model.AvailableBannerTypes, options => options.Ignore())
                .ForMember(model => model.AvailableCategoryEntity, options => options.Ignore())
