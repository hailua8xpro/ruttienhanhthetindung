    ...
    public partial class ProductController : BasePublicController
    {
        ...
        public virtual IActionResult AddProductToCompareList(int productId)
        {
            ...
            return Json(new
            {
                ...
                succsessnotify= _localizationService.GetResource("Products.ProductHasBeenAddedToCompareList.Link"),
        ...
        #endregion
        #region quick view
        public virtual IActionResult PopupQuickViewProduct(int productId)
        {
            var product = _productService.GetProductById(productId);
            ...
            if (notAvailable)
                ...
                {
                    success = false,
                    message = "Sản phẩm đã bị xóa hoặc không tồn tại"
                });
            var model = _productModelFactory.PrepareProductQuickViewModel(product);
            return Json(new
            {
                success = true,
