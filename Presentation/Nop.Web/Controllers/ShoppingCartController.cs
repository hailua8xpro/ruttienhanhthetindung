                ...
                case ShoppingCartType.Wishlist:
                    {
                        ...
                        return Json(new
                        {
                            ...
                            succsessnotify = _localizationService.GetResource("Products.ProductHasBeenAddedToTheWishlist.Link")
                        });
                    }
                ...
                default:
                    {
                        ...
                        return Json(new
                        {
                            ...
                            succsessnotify = string.Format(_localizationService.GetResource("ShoppingCart.AddCartSuccessNotify"), product.Name),
